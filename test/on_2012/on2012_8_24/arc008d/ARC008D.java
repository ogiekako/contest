package on_2012.on2012_8_24.arc008d;
...
public class ARC008D {
    public void solve(int testNumber, MyScanner in, PrintWriter out) {
        ...
        int N = set.size();
        SegTreeSemigroup<Pair<Double, Double>> seg = new SegTreeSemigroup<Pair<Double, Double>>(N) {
            @Override
            ...
            */
            @Override
            protected Pair<Double, Double> operate(Pair<Double, Double> first, Pair<Double, Double> second) {
