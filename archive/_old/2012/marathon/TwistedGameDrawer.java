...
public class TwistedGameDrawer {
    ...
    String dumpFile = "module/src/" + "res.dmp";
    String resFile = "module/src/" + "pic.gif";
    int base;
    int black = 4 * 10000;
    ...
    public void processData() {
        ...
        List<Instruction> toDraw = generateInstructions(br);

        BufferedImage bi = generateImage(toDraw);
    ...
    public static BufferedImage generateImageFromBuffer(BufferedReader br) {
        TwistedGameDrawer obj = new TwistedGameDrawer();
        List<Instruction> is = obj.generateInstructions(br);
        BufferedImage res = obj.generateImage(is);
        return res;
    }

    private BufferedImage generateImage(List<Instruction> toDraw) {
    ...
    private List<Instruction> generateInstructions(BufferedReader br) {
        try {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < args.length; i++) {
            if (args[i].equals("-dump")) {
                obj.dumpFile = args[++i];
                System.out.println("dump " + obj.dumpFile);
            } else if (args[i].equals("-res")) {
                obj.resFile = args[++i];
                System.out.println("res " + obj.resFile);
