...
public abstract class GraphGenerator {
    ...
    public static final GraphGenerator SIMPLE = new GraphGenerator() {@Override public boolean isValid(Graph graph) {
        ...
        for (int i = 0; i < graph.size(); i++)for(Edge e:graph.edges(i)){
    ...
    public static final GraphGenerator ANY = new GraphGenerator() {@Override public boolean isValid(Graph graph) {
            return true;
    }};
